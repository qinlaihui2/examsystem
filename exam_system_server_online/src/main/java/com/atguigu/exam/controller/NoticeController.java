...
public class NoticeController {
    ...
    public Result<List<Notice>> getLatestNotices(
            @Parameter(description = "限制数量", example = "1") @RequestParam(defaultValue = "1") int limit) {
    ...
    public Result<String> toggleNoticeStatus(
        ...
        queryWrapper.set(Notice::getIsActive,isActive);
        noticeService.update(queryWrapper);
        return Result.success("公告状态修改成功");
    }
} 